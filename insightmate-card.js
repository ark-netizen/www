(()=>{
  ...
  article.innerHTML=`
    ...
    <div class="insightmate-showcase"><div class="monitor"><div class="monitor-shell"><div class="monitor-screen"><img class="insightmate-preview" src="assets/insightmate-preview.png" alt="InsightMate 실제 공개 서비스 화면 프리뷰"></div></div><div class="monitor-neck"></div><div class="monitor-base"></div><div class="caption"><span>INSIGHTMATE / LIVE SERVICE PREVIEW</span><span>PUBLIC PREVIEW</span></div></div><div class="showcopy"><h4>브라우저에서 구분해 모으고,<br class="desktop-br">AI와 함께 해석합니다.</h4><p>실서비스에서는 브라우저 확장프로그램으로 X, YouTube, Instagram을 탐색하며 계정·게시물·댓글을 항목별로 구분해 수집합니다. 모인 데이터는 감성·키워드·관계망 분석을 거쳐 AI에게 질문하고 맥락을 해석할 수 있습니다.</p><div class="mini"><div><b>CAPTURE</b><span>계정·게시물·댓글을 구분해 필요한 반응만 확장프로그램으로 수집</span></div><div><b>INTERPRET</b><span>감성·키워드·관계망을 함께 보고 AI 대화로 의미와 다음 액션 해석</span></div></div></div></div>
